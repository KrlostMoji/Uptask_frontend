...
const ModalFormularioTarea = () => {
  ...
  useEffect(() => {
    ...
    if(tarea?._id || tarea?.id){
      setNombre(tarea.nombre)
      setId(tarea._id || tarea.id)
  ...
  const handleSubmit = async e => {
    ...
    if([nombre, descripcion, fechaEntrega, prioridad].includes('')){
      mostrarAlerta({
        msg: 'Favor de proporcionar los datos',
        error: true
      })
      return
    }
                                ...
                                <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left w-full">
                                    ...
                                    >
                                      ...
                                      >
                                        ...
                                        <textarea
                                          id='descripcion'
                                          placeholder='Describe brevemente en qué consiste la tarea'
                                          className='border-2 w-full p-2 mt-2 placeholder-gray-400 rounded-md'
                                          value={descripcion}
                                      ...
                                      <input 
                                        ...
                                        value={id ? 'Guardar cambios' : 'Agregar nueva tarea'}
                                      />
                                    </form>
                                </div>
                            </div>
